...
export const services: Service[] = [
  {
    ...
    pointsKn: ['ಕ್ಯಾಂಡಿಡ್ + ಸಾಂಪ್ರದಾಯಿಕ', 'ಎರಡು ಕ್ಯಾಮೆರಾ', 'ಅಂದದ ವಿನ್ಯಾಸದ ಆಲ್ಬಮ್'],
  },
  {
    ...
    titleKn: 'ಮದುವೆ & ಪ್ರೀ-ವೆಡ್ಡಿಂಗ್ ಫಿಲ್ಮ್‌ಗಳು',
    blurbKn:
      'ಆ ದಿನವನ್ನು ಅನುಭವಿಸಿದಂತೆಯೇ ಮರಳಿ ತೋರಿಸುವ ಸಿನಿಮ್ಯಾಟಿಕ್ ಫಿಲ್ಮ್‌ಗಳು — ಸಂಗೀತದೊಂದಿಗೆ, ಕಾಳಜಿಯಿಂದ ಸಂಕಲಿಸಿದವು.',
    pointsKn: ['ಹೈಲೈಟ್ ಫಿಲ್ಮ್', 'ಪೂರ್ಣ ಫಿಲ್ಮ್', 'ಡ್ರೋನ್ ಲಭ್ಯ'],
  },
  {
    title: 'Kids & Newborn',
    icon: 'baby',
  ...
  },
  {
    ...
    blurbKn:
      'ಬ್ರಹ್ಮಕಲಶ, ನಾಗಮಂಡಲ, ಜಾತ್ರೆ ಮತ್ತು ಪೂಜೆಗಳನ್ನು ಪ್ರತಿ ಸಂಪ್ರದಾಯಕ್ಕೂ ಗೌರವ ಸಲ್ಲಿಸಿ ದಾಖಲಿಸುತ್ತೇವೆ.',
  ...
  },
  {
    ...
    blurbKn:
      'ಯಕ್ಷಗಾನ, ನೃತ್ಯ ಮತ್ತು ಸಾಂಸ್ಕೃತಿಕ ಕಾರ್ಯಕ್ರಮಗಳ ಚಿತ್ರೀಕರಣ — ಕಲೆಯನ್ನು ಬಲ್ಲವರಿಂದ.',
  ...
  },
  {
    ...
    blurbKn:
      'ವ್ಯಕ್ತಿ, ದಂಪತಿ ಮತ್ತು ಇಡೀ ಕುಟುಂಬಕ್ಕಾಗಿ ಸ್ಟುಡಿಯೋದಲ್ಲಿ ಹಾಗೂ ನಿಮ್ಮ ಸ್ಥಳದಲ್ಲೇ ಭಾವಚಿತ್ರಗಳು.',
    pointsKn: ['ಸ್ಟುಡಿಯೋ & ಹೊರಾಂಗಣ', 'ಕುಟುಂಬದ ಗುಂಪು ಫೋಟೋ', 'ಪಾಸ್‌ಪೋರ್ಟ್ & ಪ್ರಿಂಟ್'],
  },
  {
    ...
    blurbKn:
      'ಹುಟ್ಟುಹಬ್ಬ, ವಾರ್ಷಿಕೋತ್ಸವ, ಉದ್ಘಾಟನೆ ಮತ್ತು ಸಮುದಾಯ ಸಮಾರಂಭಗಳನ್ನು ಮೊದಲಿನಿಂದ ಕೊನೆಯವರೆಗೆ ಚಿತ್ರೀಕರಿಸುತ್ತೇವೆ.',
  ...
  },
  {
    ...
    blurbKn: 'ನಮ್ಮ ಸ್ಟುಡಿಯೋದಲ್ಲೇ ಆಲ್ಬಮ್ ವಿನ್ಯಾಸ, ಗುಣಮಟ್ಟದ ಮುದ್ರಣ, ಫ್ರೇಮಿಂಗ್ ಮತ್ತು ಹಳೆಯ ಫೋಟೋಗಳಿಗೆ ಮರುಜೀವ.',
    pointsKn: ['ಆಲ್ಬಮ್ ವಿನ್ಯಾಸ', 'ಫ್ರೇಮಿಂಗ್ & ಎನ್‌ಲಾರ್ಜ್‌ಮೆಂಟ್', 'ಹಳೆಯ ಫೋಟೋಗೆ ಮರುಜೀವ'],
  },
];
